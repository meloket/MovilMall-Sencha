...
Ext.define('Ext.plugin.PullRefresh', {
    ...
    fetchLatest: function() {
        ...
        this.fireEvent('beforePullRefresh');    //custom event to send extra params before pull to refresh read fires
    ...
    onLatestFetched: function(operation) {
       ...
       /*added custom setState('release') for the list view with pull refresh plugin*/
    ...
    onScrollChange: function(scroller, x, y) {
       if (y <= 0)
       {
          ...
          /*comment "this.getState() !== "loaded" for list views with pull refresh */
