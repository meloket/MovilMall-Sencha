Ext.define('MobileApp.view.Places.PlacesRestNearByList', {
   extend: 'Ext.List',
   ...
   config: {
      ...
      store: 'PlacesRestNearByListStore',
      ...
      itemTpl: [
         ...
         '<div class="placeDetails">' +
           ...
           '<a  id="placesResNearByContactNo" class="placeContactNo" href="#">{contactNo}</a>' +
